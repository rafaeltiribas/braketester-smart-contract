...
=======
        "bytes"
        "strconv"
>>>>>>> 23520c6fa1ab3dfdfc9f3551bb0596ef27354445
...
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.nmi --tls --cafile /home/augusto/Teste_aws1_teste/projeto-nesa-2.0/host_aws/crypto-config/ordererOrganizations/nmi/orderers/orderer.nmi/msp/tlscacerts/tlsca.nmi-cert.pem -C nmi-channel -n nesa --peerAddresses localhost:9051 --tlsRootCertFiles /home/augusto/Teste_aws1_teste/projeto-nesa-2.0/host_aws/crypto-config/peerOrganizations/inmetro.br/peers/peer0.inmetro.br/tls/ca.crt -c '{"Args":["countHistory","inmetro.br"]}'

peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.nmi --tls --cafile crypto-config/ordererOrganizations/nmi/orderers/orderer.nmi/msp/tlscacerts/tlsca.nmi-cert.pem -C nmi-channel -n nesa --peerAddresses peer0.inmetro.br:7051 --tlsRootCertFiles crypto-config/peerOrganizations/inmetro.br/peers/peer0.inmetro.br/tls/ca.crt -c '{"Args":["countHistory","inmetro.br"]}'
